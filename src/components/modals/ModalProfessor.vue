...
<template>
  <div class="modal-backdrop-custom" v-if="ui.modals.prof" @click.self="ui.modals.prof = false">
    <div class="modal-sheet">
      ...
      <div class="mb-3">
        ...
        <div v-if="ui.formProf.peso === 0" style="font-size:.75rem;color:var(--text-muted);margin-top:6px">
